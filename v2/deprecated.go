...
import (
	...
	"github.com/AlisonOSouza/packr/v2/file"
...
func (b *Box) Bytes(name string) []byte {
	bb, _ := b.Find(name)
	oncer.Deprecate(0, "github.com/AlisonOSouza/packr/v2#Box.Bytes", "Use github.com/AlisonOSouza/packr/v2#Box.Find instead.")
	return bb
}

// MustBytes is deprecated. Use Find instead.
func (b *Box) MustBytes(name string) ([]byte, error) {
	oncer.Deprecate(0, "github.com/AlisonOSouza/packr/v2#Box.MustBytes", "Use github.com/AlisonOSouza/packr/v2#Box.Find instead.")
	return b.Find(name)
}

// String is deprecated. Use FindString instead
func (b *Box) String(name string) string {
	oncer.Deprecate(0, "github.com/AlisonOSouza/packr/v2#Box.String", "Use github.com/AlisonOSouza/packr/v2#Box.FindString instead.")
	return string(b.Bytes(name))
}

// MustString is deprecated. Use FindString instead
func (b *Box) MustString(name string) (string, error) {
	oncer.Deprecate(0, "github.com/AlisonOSouza/packr/v2#Box.MustString", "Use github.com/AlisonOSouza/packr/v2#Box.FindString instead.")
